...
**YOU ARE IN: `searchteam/polecats/nitro/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/searchteam/` (rig root) or other directories
...
**Your mail address:** `searchteam/polecats/nitro`
**Your rig:** searchteam
**Your Witness:** `searchteam/witness`
...
| Ask Witness for help | `gt mail send searchteam/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`searchteam/witness`) when:
...
```bash
gt mail send searchteam/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
